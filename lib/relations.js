...
export const relations = {
  ...
  // vendorContact: titleField/badgeField are NOT here — TaskDetail's contactTitle
  // and contactPropCode close over local vendors/tenants state, so they stay
  // caller-supplied props at the call site (see CLAUDE.md Canonical Linker
